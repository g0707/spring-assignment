package com.gaurav.java.jdbc.main;

import java.util.List;

import org.springframework.context.support.ClassPathXmlApplicationContext;

import com.gaurav.java.jdbc.daoImpl.SpringJdbcDaoImpl;
	...
	public static void main(String[] args)
	    {
	        ...
	        SpringJdbcDaoImpl dao = (SpringJdbcDaoImpl) context.getBean("employeeDAOImpl");
